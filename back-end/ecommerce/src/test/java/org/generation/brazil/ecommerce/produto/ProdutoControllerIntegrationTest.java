...
public class ProdutoControllerIntegrationTest {
    ...
    public void findById() {
        int id = 1;
        Produto produto = testRestTemplate.getForObject(getRootUrl("/produtos/" + id), Produto.class);
    ...
    public void update() {
        ...
        Produto produtoAtualizado = testRestTemplate.getForObject(getRootUrl("/produtos/" + id), Produto.class);
    ...
    public void delete() {
        ...
        try {
            produto = testRestTemplate.getForObject(getRootUrl("/produtos/delete/" + id), Produto.class);
